    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso_topic', models.CharField(blank=True, max_length=100, null=True, verbose_name='Thème ISO')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geonet_id', models.UUIDField(blank=True, db_index=True, null=True, unique=True, verbose_name='Identifiant de la fiche de métadonnées')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creates_jurisdiction', to=settings.AUTH_USER_MODEL, verbose_name='Créé par')),
                ('jurisdiction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='idgo_admin.Jurisdiction', verbose_name='Territoire de compétence')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geonet_id', models.UUIDField(blank=True, db_index=True, null=True, unique=True, verbose_name='UUID de la métadonnées')),
        ...
        migrations.CreateModel(
            name='Role',
            fields=[
                ('id', models.PositiveSmallIntegerField(choices=[(1, 'Referent'), (2, 'Contributeur'), (3, 'Gestionnaire CRIGE')], primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='liaisonsreferents',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Profil utilisateur'),
        ),
        migrations.AddField(
