...
from auth_users.forms import AddressField
from auth_users.forms import CityField
from auth_users.forms import ContributorField
from auth_users.forms import DescriptionField
from auth_users.forms import EMailField
from auth_users.forms import FirstNameField
from auth_users.forms import JurisdictionField
from auth_users.forms import LastNameField
from auth_users.forms import LicenseField
from auth_users.forms import OrganisatioLegalNameField
from auth_users.forms import OrganisationLogoField
from auth_users.forms import OrganisationTypeField
from auth_users.forms import PasswordField
...
class SignUpForm(forms.Form):
    ...
    class Meta(object):
        ...
        fields = user_fields + organisation_fields + extended_fields
...
class UpdateAccountForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'instance' in kwargs:
            ...
            self.fields['phone'].initial = self._instance.phone
        # else:
        #     raise Exception()
